...
function CardF(props) {
  return (
    <Card className='bg-neutral-900 transform transition-transform duration-200 hover:-translate-y-1 hover:scale-105 shadow-lg hover:shadow-xl cursor-pointer' style={{ width: '18rem' }}>
